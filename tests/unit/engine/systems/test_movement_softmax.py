...
def test_softmax_field_choice_jit_parity() -> None:
    ...
    x_py, y_py = getattr(_softmax_field_choice_jit, 'py_func', _softmax_field_choice_jit)(
        count,
        False,
        scores,
        c_x,
...
def test_flat_field_choice_jit_parity() -> None:
    ...
    func = getattr(_flat_field_choice_jit, 'py_func', _flat_field_choice_jit)
    x_py, y_py = func(count, 0, 0, 0, 0, c_x, c_y, np.zeros(4, dtype=np.float64), rand_val)
...
def test_choose_neighbour_by_flow_probability_jit_parity() -> None:
    ...
    func = getattr(_choose_neighbour_by_flow_probability_jit, 'py_func', _choose_neighbour_by_flow_probability_jit)
    x_py, y_py = func(
        0,
        0,
        0,
