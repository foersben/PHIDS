...
def test_draft_biotope_substance_and_diet_mutators_compact_substance_ids() -> None:
    ...
    activation-condition references are remapped consistently, and diet toggles mutate only valid
    matrix coordinates. The resulting invariants preserve a coherent draft-to-schema
