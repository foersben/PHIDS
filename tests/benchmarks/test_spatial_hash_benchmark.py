...
population distributed across a 40x40 grid. The benchmark validates the spatial hash's O(1)
...
def test_spatial_hash_query_benchmark(benchmark) -> None:  # type: ignore[no-untyped-def]
    """Benchmarks ECSWorld.entities_at throughput under a 2000-entity, 40x40-grid population.
