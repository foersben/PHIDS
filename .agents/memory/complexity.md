...
* **Selection Rationale:** The target function is a large API-level route hander (MCP tool) with many `if/elif` blocks and data manipulations logic making it perfect for untangling without affecting any core engine performance.
