...
## 2026-08-13 - [Signaling Bug] Learning: Action: _check_activation_condition was blocking substance synthesis initiation even for Synthesis actions. Moved the block into the ResourceWithdrawalAction branch so that Synthesis logic runs, allowing synthesis but preserving evaluation in synthesis.py for later release.
