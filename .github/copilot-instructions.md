...
4. **Memory Allocation:** Obey the "Rule of 16". Pre-allocate arrays to maximum sizes of 16 (e.g., flora, herbivores). No dynamic `np.append` or list resizing during the simulation loop.
