...
content = content.replace("def _evaluate_single_trigger_for_species(", "from phids.engine.systems.signaling.triggers import _evaluate_environmental_initiator_njit, _evaluate_herbivore_initiator_njit, _process_single_trigger, _process_single_trigger_action\n\n\ndef _evaluate_single_trigger_for_species(")
