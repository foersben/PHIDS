...
| Global unified pathfinding gradient | `phids.engine.core.flow_field`, consumed by `phids.engine.systems.interaction` | `docs/technical_architecture/engine_execution.md`, `docs/scientific_model/herbivore_behavior.md` | `tests/unit/engine/core/test_flow_field.py`, `tests/benchmarks/test_flow_field_benchmark.py` |
