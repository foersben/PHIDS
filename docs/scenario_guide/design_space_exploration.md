...
description: The Plant-Herbivore Interaction & Defense Simulator (PHIDS)
  ...
  (EEDSE)** architecture.
tags: [phids, ecs, numba, chemotaxis, eedse, optimization]
generated: {by: process:okf-updater, at: "2026-08-03T12:00:00Z"}
verified: {by: process:okf-updater, at: "2026-08-14T16:00:00Z"}
sources:
- id: agentic_log_writer
  resource: future_prospects/agentic_log_writer.md
---
...
Computed via `@njit` kernels at $O(1)$ spatial hash complexity. Herbivore swarms sample the 4-way Von-Neumann neighborhood using probabilistic softmax routing and orthokinetic momentum.
...
| **Cluster Orchestration** | Distributed Parallel Evaluation | Ray/Tune, Optuna, Typer CLI | `src/phids/engine/batch/runner.py` |
...
* **Location in Codebase**: [`src/phids/analytics/bio_database.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/bio_database.py), [`src/phids/api/schemas/`](https://github.com/foersben/PHIDS/tree/main/src/phids/api/schemas/)
...
* **Location in Codebase**: [`src/phids/analytics/dse_genotype.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/dse_genotype.py), [`src/phids/analytics/dse_pruning.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/dse_pruning.py)
...
* **Location in Codebase**: [`src/phids/telemetry/analytics.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/telemetry/analytics.py), [`src/phids/api/presenters/`](https://github.com/foersben/PHIDS/tree/main/src/phids/api/presenters/)
...
* **Location in Codebase**: [`src/phids/analytics/tuning.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/tuning.py)
...
* **Location in Codebase**: [`src/phids/analytics/dse_optimizer.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/dse_optimizer.py), [`src/phids/api/services/dse/task_manager.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/api/services/dse/task_manager.py)
...
* **Location in Codebase**: [`src/phids/api/services/dse/task_manager.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/api/services/dse/task_manager.py), [`src/phids/analytics/dse_optimizer.py`](https://github.com/foersben/PHIDS/blob/main/src/phids/analytics/dse_optimizer.py)
...
* **Ray/Tune Task Scheduling**: Scale scenario evaluations across HPC compute clusters ($O(N_{\text{simulations}})$ concurrent workers) via `phids.engine.batch.runner`.
...
* **Phase 3.2.1**: Ray/Tune task scheduler integration in `phids.engine.batch.runner`.
