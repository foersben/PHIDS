...
For detailed touchpoints on human vs. AI intervention gates across the pipeline, see [DSE Governance & Interventions](file:///home/benni/Documents/antigravity_workspace/PHIDS/docs/scenario_guide/design_space_exploration.md#5-governance--interventions-agentic-ai-in-the-loop-aitl-vs-human-in-the-loop-hitl).
