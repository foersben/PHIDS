...
* **[GPU CUDA Acceleration Engine](../technical_architecture/future_prospects/gpu_cuda_acceleration.md)**: Architecture for offloading 2D/3D reaction-diffusion PDE stencil solvers and airborne VOC advection to PyTorch and CUDA C++ GPU kernels.
