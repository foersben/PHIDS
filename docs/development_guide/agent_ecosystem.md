...
- **`dse-log-observer`**: Asynchronous telemetry observer performing generational DSE journaling and high-precision systemic anomaly detection. See [Agentic Diagnostic Log Writer](../speculative_research/agentic_log_writer.md).
