...
* **CLI Syntax:**
  ...
  uv run python scripts/validate_okf.py docs/scientific_model/part_3_signaling_and_transport/reaction_diffusion.md
...
* **CLI Syntax:**
    ...
    uv run python scripts/verify_matrix_trace_parity.py --doc docs/scientific_model/part_3_signaling_and_transport/reaction_diffusion.md
    ```
