...
def export_telemetry_data(
    ...
    try:
        ...
        if format == "csv":
            return _export_csv(filtered_rows, format, normalized_data_type, tick_interval, columns)
        elif format == "tex_table":
            return _export_tex_table(rows, format, columns, flora_ids, herbivore_ids, tick_interval)
