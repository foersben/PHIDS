...
def export_telemetry_data(
    ...
    try:
        ...
        if format == "csv":
            return _export_csv(filtered_rows, normalized_data_type, tick_interval, columns, format)
        elif format == "tex_table":
            return _export_tex_table(rows, columns, flora_ids, herbivore_ids, tick_interval, format)
