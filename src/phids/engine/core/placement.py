...
def _generate_horizontal_bands(width: int, height: int, band_count: int) -> list[tuple[int, int]]:
    coords = []
...
def _generate_vertical_bands(width: int, height: int, band_count: int) -> list[tuple[int, int]]:
    coords = []
...
def generate_banded(width: int, height: int, band_count: int, orientation: str) -> list[tuple[int, int]]:
    ...
    if orientation == "horizontal":
        return _generate_horizontal_bands(width, height, band_count)
    return _generate_vertical_bands(width, height, band_count)
