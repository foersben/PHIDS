...
"""Batch evaluation for signaling triggers."""
...
def _evaluate_trigger_batch(
    ...
    """Evaluates a single trigger across a batch of plants.

    Args:
        trig: The trigger to evaluate.
        plants: List of plants to evaluate.
        xs: Array of plant x coordinates.
        ys: Array of plant y coordinates.
        mask: Pre-allocated boolean mask array.
        world: ECS world instance.
        env: Grid environment.
        swarm_grid: Array of swarm population densities.
        owner_substance_by_key: Dictionary of substances by owner key.
        swarm_population_by_cell_species: Swarm population by cell and species.
        active_substance_ids_by_owner: Active substances by owner.
        substance_entities: List to collect new substance entities.
        curve_map: Mapping of curve string names to integer ids.
    """
