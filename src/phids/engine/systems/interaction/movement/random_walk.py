...
"""Random walk logic for undirected movement.

Provides fallback movement selection when flow fields lack distinct gradients.
"""
...
from phids.engine.systems.interaction.movement.neighbors import _gather_neighbours_jit, _gather_neighbours_jit_pow2
