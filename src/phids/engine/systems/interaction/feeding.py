...
def _feed_on_single_plant(
    ...
    digestive_efficiency = swarm_params.resistances.get("digestive_efficiency", 1.0)
    mechanical_damage_per_bite = getattr(plant_params.passive_defenses, "mechanical_damage_per_bite", 0.0)
    morphological_adaptation = swarm_params.resistances.get("morphological_adaptation", 0.0)
