"""Cell tooltip presentation layer.

This module encapsulates the logic for traversing the ECS world and double-buffered
environmental layers to extract detailed information for a single grid cell, used by
the HTMX tooltip system in both live and draft preview modes.
"""
...
from phids.api.presenters.mycorrhiza import (
