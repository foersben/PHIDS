...
def _overlay_species_data(
    ...
    for i, r in enumerate(raw_rows_for_species):
        if flora_ids:
            _overlay_flora_data(r, i, flora_ids, series)
        if herbivore_ids:
            _overlay_herbivore_data(r, i, herbivore_ids, series)
...
async def telemetry_chartjs_data(
    ...
    _overlay_species_data(raw_rows_for_species, flora_ids, herbivore_ids, series)
