...
"""Helper functions for simulation router.

This module provides internal utilities for form parsing and draft state management
to support the simulation and scenario control endpoints.
"""
