...
"""Shared HTTP helpers for the simulation router.

This module provides common parsing, fragment rendering, and draft synchronization
utilities that span across simulation lifecycle and control endpoints.
"""
