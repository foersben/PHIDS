...
"""Server-side draft state model and singleton management."""
...
class DraftState:
    ...
    Attributes:
        ...
        placement_mode: How initial entities are placed on the map.
        flora_placement_strategy: Optional strategy for procedural flora placement.
        herbivore_placement_strategy: Optional strategy for procedural herbivore placement.
