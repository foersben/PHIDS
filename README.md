...
* Want to model behavioral cascades via branchless SIMD transfer tables? Start at [`docs/development_guide/okf_data_flow_matrix_architecture.md`](docs/development_guide/okf_data_flow_matrix_architecture.md).
